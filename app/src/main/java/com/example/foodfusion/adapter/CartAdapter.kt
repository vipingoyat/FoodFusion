...
class CartAdapter(
    ...
    inner class CartViewHolder(private val binding: CartItemBinding) :
        ...
        private fun deleteItem(position: Int) {
            val positioRetrieve = position
            getUniqueKeyatPosition(positioRetrieve){
                uniqueKey ->
                if(uniqueKey!= null){
        ...
        private fun getUniqueKeyatPosition(positioRetrieve: Int, onComplete:(String?) -> Unit) {
